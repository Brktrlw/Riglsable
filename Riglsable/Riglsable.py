...
########################################---------Buttons-------########################################
        ...
        self.pushButton_local_scan.setStyleSheet("color : black;")
...
########################################---------Functions-----########################################
    ...
    def subdomain(self):
        if self.lineEdit_site.text()=="":
            ...
            msg1.setText("Please enter the site adress or IP adress!")
            msg1.exec_()
        elif self.lineEdit_site.text()[:5]=="http:":
            self.plainTextEdit_result.clear()
            self.plainTextEdit_result.insertPlainText("Searching subdomains,please wait...")
            os.system("gnome-terminal --window -x dnsmap {} -r output.txt".format(self.lineEdit_site.text().lower()[7:]))
            msg2 = QMessageBox()
            msg2.setWindowTitle("Information")
            msg2.setBaseSize(300,300)
            msg2.setIcon(QMessageBox.Warning)
            ...
            msg2.exec_()
        elif self.lineEdit_site.text()[:6]=="https:":
            self.plainTextEdit_result.clear()
            self.plainTextEdit_result.insertPlainText("Searching subdomains,please wait...")
            os.system("gnome-terminal --window -x dnsmap {} -r output.txt".format(self.lineEdit_site.text().lower()[8:]))
            msg2 = QMessageBox()
            msg2.setWindowTitle("Information")
            msg2.setBaseSize(300,300)
            msg2.setIcon(QMessageBox.Warning)
